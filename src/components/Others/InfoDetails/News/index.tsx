...
function News() {
  ...
  return (
    <div className="row-span-2 flex h-full flex-col items-center justify-center gap-3 text-pretty rounded-lg border-[#1c2f4a] bg-[#132238] p-4 text-3xl italic md:col-span-2 md:text-5xl">
